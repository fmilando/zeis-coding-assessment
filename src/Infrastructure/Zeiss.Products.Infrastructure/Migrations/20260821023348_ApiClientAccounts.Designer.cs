...
namespace Zeiss.Products.Infrastructure.Migrations
{
    ...
    [Migration("20260821023348_ApiClientAccounts")]
    partial class ApiClientAccounts
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Zeiss.Products.Infrastructure.Database.Entities.InventoryEntity", b =>
                {
                    b.HasOne("Zeiss.Products.Infrastructure.Database.Entities.ProductEntity", null)
                        .WithOne("Inventory")
                        .HasForeignKey("Zeiss.Products.Infrastructure.Database.Entities.InventoryEntity", "ProductId")
